package com.sam.arch;

import com.sam.arch.exception.WrongZipFileException;
...
public class Archiver {
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            } catch (WrongZipFileException e) { ConsoleHelper.writeMessage("Вы не выбрали файл архива или выбрали неверный файл.");
            } catch (Exception e) { ConsoleHelper.writeMessage("Произошла ошибка. Проверьте введенные данные."); }
